...
//        library.insert("Harry Potter and the philosopher's stone", "0001", "J. K. Rownling", "Puffin");
//        library.insert("To Kill a Mockingbird", "1234", "Harper Lee", "HarperCollins");
//        library.insert("1984", "5678", "George Orwell", "Penguin Books");
//        library.insert("The Great Gatsby", "9101", "F. Scott Fitzgerald", "Scribner");
...
//        library.insert("The Shadow of the Wind", "1111", "Carlos Ruiz Zafón", "PublisherA");
...
//        library.insert("The Girl with the Dragon Tattoo", "8888", "Stieg Larsson", "PublisherH");
...
//        library.insert("Harry Potter and the Chamber of Secrets", "0002", "J. K. Rownling", "Puffin");
//        library.insert("Harry Potter and the Prisoner of Azakaban", "0003", "J. K. Rownling", "Puffin");
//        library.insert("Harry Potter and the Goblet of Fire", "0004", "J. K. Rownling", "Puffin");
//        library.insert("Harry Potter and the Order of the Phoenix", "0005", "J. K. Rownling", "Puffin");
//        library.insert("Harry Potter and the Half-Blood Prince", "0006", "J. K. Rownling", "Puffin");
//        library.insert("Harry Potter and the Deathly Hallows", "0007", "J. K. Rownling", "Puffin");
